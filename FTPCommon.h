...
#define FTP_CMD_LE_XPWD 0x44575058      // "XPWD" as uint32_t (little endian)
#define FTP_CMD_BE_XPWD 0x58505744      // "XPWD" as uint32_t (big endian)
...
#define FTP_CMD_BE_XMKD 0x584d4b44      // "XMKD" as uint32_t (big endian)
...
#define FTP_CMD_LE_APPE 0x45505041      // "APPE" as uint32_t (little endian)
#define FTP_CMD_BE_APPE 0x41505045      // "APPE" as uint32_t (bit endian)
